// Dependency-free SHA-256 (sync, no imports) for canonical content hashing
// in both Node tests and the browser bundle.
...
export function sha256Hex(text: string): string {
  ...
  // 64-bit big-endian length; JS bitwise is 32-bit so split high/low.
